 ...
 * @LastEditTime: 2022-06-18 12:10:59
 * @Description: 富文本编辑器二次封装
 * @Email: Rv_Jiang@outlook.com
-->
<script setup lang="ts" name="rvEditor">
  import MdEditor from 'md-editor-v3'
  import 'md-editor-v3/lib/style.css'

  const emit = defineEmits(['update:value', 'getCatalog', 'save'])
...
<template>
  <div id="rv-editor">
    ...
    <md-editor
      ...
      editor-id="rv-editor-body"
      :preview-theme="props.theme"
  ...
  #rv-editor {
    #rv-editor-body {
      ...
      :deep(pre) {
        position: relative;
        border-radius: 5px;
        box-shadow: #00000055 0px 2px 2px;
